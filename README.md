...
- <img src="https://cdn.simpleicons.org/kubernetes/326CE5" height="14"/> [KubeStellar Console](https://github.com/kubestellar/console) - Multi-cluster Kubernetes dashboard with MCP server (kc-agent) for AI-assisted operations across edge and cloud clusters
