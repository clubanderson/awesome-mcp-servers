...
- <img src="https://cdn.simpleicons.org/kubernetes/326CE5" height="14"/> [KubeStellar Console kc-agent](https://github.com/kubestellar/console)<sup><sup>4</sup></sup> - AI-powered multi-cluster Kubernetes MCP server. Enables AI assistants to manage workloads, query health, and orchestrate operations across edge and cloud clusters with CNCF project integrations.
